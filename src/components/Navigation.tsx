...
export default function Navigation() {
  ...
  return (
    ...
    >
        ...
        <div className="bg-[#1a1a1a]/95 backdrop-blur-lg rounded-full border border-white/10 shadow-2xl">
            ...
            <div className="flex items-center space-x-8">
              ...
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Link
                    href="/auth/register"
                    className="w-[125px] h-10 hover:opacity-90 transition-opacity"
                  >
                    <StartSellingButton />
                  </Link>
                </>
          ...
          <div className="md:hidden flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-lg hover:opacity-80 transition-opacity focus:outline-none"
              style={{ color: "var(--nav-text)" }}
            >
              {isMenuOpen ? (
                <X className="h-6 w-6" />
            ...
            {!isAuthenticated && (
              <Link
                href="/auth/register"
                className="px-4 py-2 rounded-full text-black text-sm font-semibold hover:opacity-90 transition-opacity"
      ...
      {isMenuOpen && (
        <div
          className="md:hidden mt-2 mx-4 rounded-2xl p-4 space-y-3 bg-[#1a1a1a]/95 backdrop-blur-lg border border-white/10"
        >
          <Link
            href="/products"
          ...
          {isAuthenticated ? (
            <>
              ...
              >
                <div className="px-4 py-2 mb-2 rounded-lg" style={{ background: "var(--nav-hover-bg)" }}>
                  <span className="text-sm text-white font-medium" style={{ color: "var(--nav-text)" }}>
                ...
                <button
                  ...
                  className="text-white font-medium flex items-center px-4 py-2 rounded-lg hover:opacity-80 transition-opacity w-full"
                  style={{ color: "var(--nav-text)" }}
                >
