...
export function HowItWorksSection() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 relative z-10">
            {steps.map((step, index) => (
              ...
              >
                {/* Clean card */}
                <div className="relative bg-white border border-gray-200 rounded-2xl p-6 sm:p-7 md:p-8 h-full flex flex-col items-center text-center transition-all duration-300 group-hover:border-gray-300 group-hover:shadow-lg group-hover:-translate-y-1">

                  {/* Step indicator */}
                  <div className="relative w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 mb-5 sm:mb-6">
                    {/* Background circle */}
                    <div className="absolute inset-0 rounded-full bg-gray-50 border border-gray-200 transition-all duration-300 group-hover:bg-accent/10 group-hover:border-accent/30"></div>
                  ...
                  {/* Title */}
                  <h3 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mb-3 sm:mb-4 group-hover:text-accent transition-all duration-300 leading-tight">
                    {step.title}
                  </h3>
        ...
        <div className="mt-16 sm:mt-20 md:mt-24 text-center">
          <div className="max-w-2xl mx-auto">
            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-4 sm:mb-6 leading-tight tracking-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
              <button className="group bg-accent hover:bg-accent/90 text-white px-6 sm:px-8 py-3 sm:py-3.5 rounded-xl font-semibold text-sm sm:text-base transition-all duration-300 w-full sm:w-auto">
              ...
              <button className="group bg-white hover:bg-gray-50 text-gray-900 px-6 sm:px-8 py-3 sm:py-3.5 rounded-xl font-medium text-sm sm:text-base transition-all duration-300 border border-gray-200 hover:border-gray-300 w-full sm:w-auto">
