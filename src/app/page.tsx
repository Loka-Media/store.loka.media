...
import { ArrowRight, Users, UserCheck, Shield, Store, ShoppingBag } from 'lucide-react';
                ...
                <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                  <div>
                    ...
                    <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                      Connect creators with customers. Build your marketplace, showcase products, and grow your business with our comprehensive platform.
                    </p>
                    <div className="mt-10 space-y-4 sm:space-y-0 sm:flex sm:justify-center lg:justify-start">
                      ...
                      {!isAuthenticated ? (
                        ...
                        <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                          <Link
                            href={user?.role === 'creator' ? '/dashboard/creator' : '/dashboard'}
                            className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10"
                          >
                            <Store className="mr-2 w-5 h-5" />
                            {user?.role === 'creator' ? 'Creator Dashboard' : 'My Dashboard'}
                          </Link>
                        </div>
                      )}
                    </div>
                      ...
                      <div className="mt-6">
                        ...
                        <div className="mt-6">
                          <div className="text-center">
                            ...
                            <p className="text-xs text-gray-500">admin@customcatalog.com</p>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              <div className="flex">
                ...
                <div className="ml-4">
                  <dt className="text-lg leading-6 font-medium text-gray-900">Multi-Role Support</dt>
                  <dd className="mt-2 text-base text-gray-500">
                    Support for users, creators, and admins with role-based access control.
                  </dd>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  <dt className="text-lg leading-6 font-medium text-gray-900">Secure Authentication</dt>
                  <dd className="mt-2 text-base text-gray-500">
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  <dt className="text-lg leading-6 font-medium text-gray-900">Creator Tools</dt>
                  <dd className="mt-2 text-base text-gray-500">
                    Comprehensive tools for creators to manage their products and sales.
                  </dd>
                </div>
              </div>
            </div>
