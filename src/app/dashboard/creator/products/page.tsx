    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="border-b border-white/10 bg-gradient-to-b from-white/5 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pb-6 sm:pb-8">
            <GradientTitle text="Your Products" size="lg" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                ...
                <option value="T-Shirts" className="bg-black">T-Shirts</option>
                <option value="Hoodies" className="bg-black">Hoodies</option>
                <option value="Mugs" className="bg-black">Mugs</option>
                <option value="Posters" className="bg-black">Posters</option>
              </select>
              ...
              <select
                ...
                className="px-4 py-2.5 sm:py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-white/40 transition-all text-sm sm:text-base"
              >
                <option value="created_at-DESC" className="bg-black">Newest First</option>
                <option value="created_at-ASC" className="bg-black">Oldest First</option>
                <option value="name-ASC" className="bg-black">Name: A to Z</option>
                <option value="name-DESC" className="bg-black">Name: Z to A</option>
                <option value="base_price-ASC" className="bg-black">Price: Low to High</option>
                <option value="base_price-DESC" className="bg-black">Price: High to Low</option>
              </select>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-xs sm:text-sm font-medium text-gray-400">
                <span className="text-white/80">{filteredProducts.length}</span> products
              </div>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="gradient-border-white-top overflow-x-auto">
  ...
  return (
    ...
    >
      <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
        <div className="flex items-center gap-3">
          <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12">
            <div className="relative rounded-lg overflow-hidden border border-white/20 group-hover:border-white/40 transition-colors" style={{ aspectRatio: '1/1' }}>
              <Image
                src={product.thumbnail_url || '/placeholder-product.png'}
                alt={product.name}
                fill
      ...
      <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-white font-medium">
        {formatPrice(product.min_price)}
        {product.max_price > product.min_price && (
          <div className="text-gray-400 text-xs">to {formatPrice(product.max_price)}</div>
        )}
      </td>
      <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
