...
import { Save, AlertCircle, CheckCircle, Eye, EyeOff, Lock, DollarSign } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-black to-gray-900 p-4 sm:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 sm:mb-12">
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Payout Settings</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Save Button - Creative */}
          <button
            type="submit"
            disabled={saving}
            className="w-full bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 hover:from-orange-600 hover:via-orange-700 hover:to-orange-800 text-white font-bold py-4 px-4 rounded-lg transition-all flex items-center justify-center gap-3 disabled:opacity-50 text-lg shadow-lg hover:shadow-xl hover:shadow-orange-500/20"
          >
        ...
        {/* Security Notice - Creative */}
        <div className="mt-8 gradient-border-white-top rounded-lg p-4 sm:p-6 bg-gray-900/50 border border-gray-700/50 text-center">
