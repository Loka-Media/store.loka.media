...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Header */}
      <div className="border-b border-white/10 bg-gradient-to-b from-white/5 to-transparent mt-4 sm:mt-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="pb-4 sm:pb-8 pt-4 sm:pt-8 text-center sm:text-left">
            <GradientTitle text="My Profile" size="lg" />
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
        {/* Profile Overview */}
        <div className="gradient-border-white-top p-4 sm:p-8 mb-6 sm:mb-8 rounded-2xl">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 mb-4 sm:mb-6 pb-4 sm:pb-6 border-b border-white/10">
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/profile/edit"
                className="inline-flex items-center px-3 py-1.5 text-white font-medium rounded-lg hover:bg-white/10 transition-all text-xs sm:text-sm gap-1.5 whitespace-nowrap"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-6">
            {/* Profile Card */}
            <div className="gradient-border-white-right rounded-2xl p-3 sm:p-4 flex items-center gap-4 min-h-[90px] sm:min-h-[110px]">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl overflow-hidden flex-shrink-0 bg-gradient-to-br from-purple-400 to-pink-400 relative">
                {user?.profileImg ? (
                  <img
            ...
            {/* Phone Card */}
            <div className="gradient-border-white-top rounded-2xl p-3.5 sm:p-6 flex flex-row lg:flex-col justify-between items-center lg:items-start min-h-[70px] sm:min-h-[110px] gap-2">
              ...
              <span className="text-white text-xs sm:text-sm font-medium font-satoshi truncate">
        ...
        {/* Tabs */}
        <div className="gradient-border-white-bottom p-1.5 sm:p-3 mb-6 sm:mb-8 rounded-2xl">
          <nav className="grid grid-cols-3 gap-1.5 sm:gap-3 w-full">
            {[
              ...
              <button
                ...
                className={`py-2.5 sm:py-3.5 px-2 sm:px-6 font-bold text-[11px] xs:text-xs sm:text-sm flex items-center justify-center cursor-pointer gap-1 sm:gap-2 rounded-full transition-all text-center truncate ${activeTab === key
        ...
        {activeTab === 'overview' && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6">
            {/* Total Orders */}
            <div className="gradient-border-white-top p-4 sm:p-6 hover:bg-white/5 transition-all rounded-2xl h-[100px] sm:h-[130px] flex flex-col justify-between">
