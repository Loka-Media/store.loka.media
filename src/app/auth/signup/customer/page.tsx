...
import { Eye, EyeOff, User, Mail, Phone, Lock, ShoppingBag, Sparkles } from "lucide-react";
        ...
        <div className="relative z-10 flex flex-col justify-center px-4 sm:px-6 lg:px-8 xl:px-16 py-6 sm:py-8 lg:py-0 mt-16 lg:mt-16">
          <div className="max-w-lg">
            <div className="mb-3 sm:mb-4 lg:mb-6">
              <GradientTitle text="Shop with Confidence" size="lg" />
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 lg:gap-4 mb-6 sm:mb-8 lg:mb-12">
              ...
              <div className="text-center flex flex-col items-center">
                ...
                <div className="text-xs text-white">Happy Customers</div>
              </div>
              <div className="text-center flex flex-col items-center">
                <StartShape className="max-w-[80px] sm:max-w-[100px]">
                  <div className="flex justify-center">
                ...
                <div className="text-xs text-white">Orders Fulfilled</div>
              </div>
            </div>
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              {[
                "Browse exclusive artisan products",
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center p-1 bg-[#121212] border border-white/15 rounded-xl mb-4 sm:mb-6 shadow-inner">
                <div className="flex-1 py-2 sm:py-2.5 px-3 rounded-lg text-xs sm:text-sm font-extrabold transition-all text-center flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white shadow-lg ring-1 ring-white/20">
              ...
              <div className="mb-4 sm:mb-6 lg:mb-8">
                <GradientTitle text="Join as a Customer" size="sm" />
                <GradientText className="text-xs sm:text-sm mt-2 sm:mt-3 lg:mt-4">
                  Shop unique products from talented creators
                </GradientText>
              </div>
                ...
                <div className="lg:col-span-2">
                  <div className="relative">
                    ...
                    <input
                      {...register("name")}
                      type="text"
                      className="block w-full pl-10 pr-3 py-2 sm:py-3 bg-transparent border border-white/20 rounded-lg sm:rounded-xl text-xs sm:text-sm placeholder-white/40 text-white font-medium focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all"
                ...
                <div>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 pr-10 py-2 sm:py-3 bg-transparent border border-white/20 rounded-lg sm:rounded-xl text-xs sm:text-sm placeholder-white/40 text-white font-medium focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all"
...
CustomerSignupContent.displayName = "CustomerSignupContent";
