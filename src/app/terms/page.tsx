    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 mt-16">
        <div className="prose prose-lg prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">3. Accounts and Registration</h2>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">4. Creator Accounts</h2>
          
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">4.1 Creator Application Process</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">4.2 Creator Responsibilities</h3>
          ...
          <h3 className="text-xl font-semibold text-white mt-6 mb-3">4.3 Creator Earnings</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">6. Returns and Refunds</h2>
          ...
          <p>
            If you have any questions about these Terms, please contact us at <a href="mailto:legal@loka.media" className="text-blue-400 hover:text-blue-300">legal@loka.media</a>.
          </p>
        </div>
      </div>
    </div>
