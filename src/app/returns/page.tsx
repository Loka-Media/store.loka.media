    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 mt-16">
        <div className="prose prose-lg max-w-none">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Returns & FAQ</h1>

          <p>
            We want to make sure you love our products, and quality is guaranteed. If there is a print error or visible quality issue, we'll replace or refund it. For any quality issues, be sure to provide clear photos of the products on a flat, well-lit surface and include this in your email to us at <a href="mailto:support@loka.media" className="text-pink-500 hover:text-pink-600">support@loka.media</a>. This quick and simple step will help us provide a speedy resolution.
          </p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Product Orders Cancellation Policy</h3>
          <p>
            All of our products are made to order, especially for you. If you wish to cancel or amend your order, please contact us as soon as possible at <a href="mailto:support@loka.media" className="text-pink-500 hover:text-pink-600">support@loka.media</a>. You can edit your order at any time before it goes to production.
          </p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Damaged/Quality Issues</h2>
          ...
          <p>
            Please email us with these details at <a href="mailto:support@loka.media" className="text-pink-500 hover:text-pink-600">support@loka.media</a>
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Refunds Policies</h2>

          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Product Orders Refund Policy</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Accepted Payment Methods</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">International Orders</h2>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">How do I track my order?</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">What if my package is lost or stolen?</h3>
          <p>
            Please contact us immediately at <a href="mailto:support@loka.media" className="text-pink-500 hover:text-pink-600">support@loka.media</a> if you believe your package was lost or stolen. We'll work with you to resolve the issue.
          </p>

          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Can I change my shipping address after placing an order?</h3>
          <p>
            Address changes may be possible if the order hasn't gone into production yet. Contact us as soon as possible at <a href="mailto:support@loka.media" className="text-pink-500 hover:text-pink-600">support@loka.media</a> with your order number and new address.
          </p>

          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">What materials are used for your products?</h3>
          <p>
          ...
          <ul>
            <li><strong>Email:</strong> <a href="mailto:support@loka.media" className="text-pink-500 hover:text-pink-600">support@loka.media</a></li>
            <li><strong>General Inquiries:</strong> <a href="mailto:hello@loka.media" className="text-pink-500 hover:text-pink-600">hello@loka.media</a></li>
          </ul>
